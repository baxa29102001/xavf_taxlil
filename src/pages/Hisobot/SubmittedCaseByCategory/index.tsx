...
const Index = () => {
  ...
  const [masulSelect, setMasulSelect] = useState<
  ...
  const { isLoading } = useQuery(
    ["submitted-cases-by-category", searchValue, year, quarter, masulId],
    () =>
      axiosT.get<{ categories: ISubmitedCase[] }>(
        `/reports/submitted-cases-by-category/`,
        {
          params: {
            year: year,
            search: searchValue,
    ...
    <div>
      <div className={"grid grid-cols-12"}>
        <div className="col-span-6">
          <PageTitle
            title={"Ijrochilardan kelib tushgan holatlar yo‘nalishlar kesimida"}
            back
          />
        </div>
